...
const defaultContent = {
  ...
  context: {
    line1: "This is especially made for you.",
    line2: "With love and care.",
    button: "Continue",
  },
  anticipation: {
  ...
  question: {
    ...
    yesButton: "I love this 💕",
    thinkButton: "Thanks 😊",
  },
  yesResponse: {
    line1: "You just made my day 💝",
    line2: "Forever grateful for you.",
  },
  thinkingResponse: {
    line1: "You're the best 💖",
    line2: "Happy Valentine's Day.",
  },
};

const getContent = (personalized?: PersonalizedInfo) => {
  if (!personalized) return defaultContent;
  
  return {
    curiosity: {
      text: `Hi ${personalized.toName}! 💌`,
      button: "Open",
    },
    context: {
      line1: `This is a special gift from ${personalized.fromName}...`,
      line2: "Made just for you.",
      button: "Continue",
    },
    anticipation: {
    ...
    yesResponse: {
      line1: `${personalized.toName}, you're amazing! 💝`,
      line2: `- ${personalized.fromName}`,
    },
    thinkingResponse: {
      line1: `You're the best, ${personalized.toName}! 💖`,
      line2: `With love, ${personalized.fromName}`,
    },
  };
};

const ValentineExperience = ({ onComplete, personalized }: ValentineExperienceProps) => {
  const content = getContent(personalized);
